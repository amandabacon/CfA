...
coeff_arr_110943_clean = IRIS_PREP_DESPIKE(REFORM(coeff_arr_110943[0,*,*]), niter = 1000, min_std = 2.8, sigmas = 2.5, mode = 'both')

;velocity calculation for doppler shift

velocity_110943 = ((coeff_arr_110943[1,*,*]-wave0_110943)/wave0_110943) * 3e5

velocity_110943_clean = IRIS_PREP_DESPIKE(REFORM(velocity_110943), niter = 1000, min_std = 2.8, sigmas = 2.5, mode = 'both')

;velocity calc. for line width

vel_width_110943 = (coeff_arr_110943[2,*,*]/wave0_110943) * 3e5 * sqrt(2)

vel_width_110943_clean = IRIS_PREP_DESPIKE(REFORM(vel_width_110943), niter = 1000, min_std = 2.8, sigmas = 2.5, mode = 'both')

;plot intensity

EIS_COLORS, /INTENSITY

PLOT_IMAGE, REFORM(coeff_arr_110943_clean), ORIGIN = [solarx1400_110943[0], solary1400_110943[0]], SCALE = [ResX1400_110943, ResY1400_110943], MIN = 5, MAX = 75, XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL
...
PLOT_IMAGE, REFORM(vel_width_110943_clean), ORIGIN = [solarx1400_110943[0], solary1400_110943[0]], SCALE = [ResX1400_110943, ResY1400_110943], MIN = 7, MAX = 75, XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0+dx,y0,x0+(2.0*dx),y0+dy], /CURRENT, /NORMAL, /NOERASE, YCHARSIZE = 0.001
...
PLOT_IMAGE, REFORM(velocity_110943_clean), ORIGIN = [solarx1400_110943[0], solary1400_110943[0]], SCALE = [ResX1400_110943, ResY1400_110943], MIN = -35, MAX = 35, XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0+(2.0*dx),y0,x0+(3.0*dx),y0+dy], /CURRENT,/NORMAL,/NOERASE, YCHARSIZE = 0.001, TOP = 254
...
EIS_COLORS, /INTENSITY
PLOT_IMAGE, REFORM(coeff_arr_110943_clean), ORIGIN = [solarx1400_110943[0], solary1400_110943[0]], SCALE = [ResX1400_110943, ResY1400_110943], MIN = 5, MAX = 75, XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, XTHICK = 4, YTHICK = 4, XSTYLE = 1, THICK = 4, CHARSIZE = 1.8, XCHARSIZE = 1.45, YCHARSIZE = 1.45
...
EIS_COLORS, /WIDTH
PLOT_IMAGE, REFORM(vel_width_110943_clean), ORIGIN = [solarx1400_110943[0], solary1400_110943[0]], SCALE = [ResX1400_110943, ResY1400_110943], MIN = 7, MAX = 75, XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0+dx,y0,x0+(2.0*dx),y0+dy], /CURRENT, /NORMAL, /NOERASE, YCHARSIZE = 0.001, XTHICK = 4, YTHICK = 4, XSTYLE = 1, THICK = 4, CHARSIZE = 1.8, XCHARSIZE = 1.45
...
SET_PLOT, 'ps'
DEVICE, XSIZE = 25, YSIZE = 12, /INCHES, COLOR = 1, BITS_PER_PIXEL = 8, SET_FONT = 'TIMES', /TT_FONT, FILENAME = '/data/khnum/REU2018/abacon/data/detection/AR11850_20130925_110943/param_maps/param_plot_110943.eps', /ENCAPSULATED

EIS_COLORS, /INTENSITY
PLOT_IMAGE, REFORM(coeff_arr_110943_clean), ORIGIN = [solarx1400_110943[0], solary1400_110943[0]], SCALE = [ResX1400_110943, ResY1400_110943], MIN = 5, MAX = 75, XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL, XSTYLE = 1, THICK = 4, CHARSIZE = 1.8, XCHARSIZE = 1.35, YCHARSIZE = 1.4, YTHICK = 10, XTHICK = 10
COLORBAR, FORMAT = '(F0.2)', TITLE = "Intensity [Arbitrary Units]", RANGE = [5,75], /YLOG, YTICKS = 10, POSITION = [0.07,0.75,0.33,0.76], /TOP, CHARSIZE = 1.4
