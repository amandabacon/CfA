...
g = 7.2 ;photons/count
dt = 2.0
inst_unc = [ABS((REFORM(nspectraRast1403_055943_1_Oiv[*,UVB_ind_y_055943_1_Oiv,UVB_ind_r_055943_1_Oiv]))/(g*dt))+R]^0.5
;PRINT, inst_unc
...
FOR i = 0, UVB_size_055943_1_Oiv-1 DO BEGIN
	PLOT, lambda1403_055943_1_Oiv[19:99], REFORM(nspectraRast1403_055943_1_Oiv[*,UVB_ind_y_055943_1_Oiv[i],UVB_ind_r_055943_1_Oiv[i]]), XRANGE = [1399.3, 1405.8], TITLE = 'AR11850_055943_1_Oiv Gaussian Fit', XTITLE = 'Wavelength', YTITLE = 'Intensity'
	YFIT_055943_1_Oiv2 = MPFITPEAK(lambda1403_055943_1_Oiv[19:99], REFORM(nspectraRast1403_055943_1_Oiv[*,UVB_ind_y_055943_1_Oiv[i],UVB_ind_r_055943_1_Oiv[i]]), coeff_055943_1_Oiv2, NTERMS = 4, PERROR = sigma_coeff, ERROR = inst_unc[*,i,i], ESTIMATES = [5.0,1401.163,0.1,0.0])
...
;PRINT, coeff_arr_055943_1_Oiv2
;PRINT, sigma_coeff_arr

p_int = coeff_arr_055943_1_Oiv2[0,*,*]
sig_lw = sigma_coeff_arr[2,*,*]
lw = coeff_arr_055943_1_Oiv2[2,*,*]
...
PRINT, SIZE(SNR)
SNR2 = WHERE((SNR LT 27), count)
PRINT, SIZE(SNR[SNR2])

PLOT, HISTOGRAM(SNR[SNR2], BINSIZE = 1.0), PSYM = 10, XTITLE = "Signal-to-Noise", YTITLE = "Histogram Density", TITLE = "Histogram of Signal-to-Noise of AR11850_20130926_055943_1"
OPLOT, HISTOGRAM(SNR[SNR2], BINSIZE = 1.0), COLOR = 150

;save as png

WINDOW, XSIZE = 900, YSIZE = 700, RETAIN = 2
PLOT, HISTOGRAM(SNR[SNR2], BINSIZE = 1.0), PSYM = 10, XTITLE = "Signal-to-Noise", YTITLE = "Frequency", TITLE = "Histogram of Signal-to-Noise of AR11850_20130926_055943_1"
OPLOT, HISTOGRAM(SNR[SNR2], BINSIZE = 1.0), COLOR = 150
...
SET_PLOT, 'ps'
DEVICE, XSIZE = 8, YSIZE = 8, /INCHES, COLOR = 1, BITS_PER_PIXEL = 8, SET_FONT = 'TIMES', /TT_FONT, FILENAME = '/data/khnum/REU2018/abacon/data/detection/Oiv_1401_SGF/20130926_055943/raster1/histogram_055943_1.eps', /ENCAPSULATED
...
SAVE, coeff_055943_1_Oiv2, inst_unc, sigma_coeff, sigma_coeff_arr, coeff_arr_055943_1_Oiv2, It, int_int_unc, SNR_0, SNR, FILENAME = sfname2
