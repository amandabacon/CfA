...
PLOT, psym = 3, vel_width, coeff_arr[0,*,*], XTITLE = 'Line Width [km*s^-1]', YTITLE = 'Peak Instensity [Arb. Units]', TITLE = 'Scatter Plot of Intensity vs Width', /XLOG, /YLOG, XRANGE = [10e-2,10e6]

;perform isolation of UV burst region

WINDOW, XSIZE = 900, YSIZE = 500
PLOT, psym = 3, vel_width[not_cut_ind], coeff_arr_peak[not_cut_ind], XTITLE = 'Line Width [km*s^-1]', YTITLE = 'Peak Instensity [Arb. Units]', TITLE = 'Scatter Plot of Intensity vs Width', /XLOG, /YLOG, XRANGE = [10e-2,10e6]
TVLCT, [[255], [0], [0]], 255
...
TVLCT, [[255], [255], [255]], 0
PLOT, psym = 3, vel_width, coeff_arr[0,*,*], XTITLE = 'Line Width [km*s^-1]', YTITLE = 'Peak Instensity [Arb. Units]', TITLE = 'Scatter Plot of Intensity vs Width', /XLOG, /YLOG, XRANGE = [10e-2,10e6], COLOR = 0
...
WINDOW, XSIZE = 900, YSIZE = 500, RETAIN = 2
TVLCT, [[255], [255], [255]], 0
PLOT, psym = 3, vel_width[not_cut_ind], coeff_arr_peak[not_cut_ind], XTITLE = 'Line Width [km*s^-1]', YTITLE = 'Peak Instensity [Arb. Units]', TITLE = 'Scatter Plot of Intensity vs Width', /XLOG, /YLOG, XRANGE = [10e-2,10e6], COLOR = 0
TVLCT, [[255], [0], [0]], 255
OPLOT, psym = 3, vel_width[cut_ind], coeff_arr_peak[cut_ind], COLOR = 255
screenshot = TVRD(TRUE = 1)
...
SET_PLOT, 'ps'
DEVICE, COLOR = 0, BITS_PER_PIXEL = 8, FILENAME = '/data/khnum/REU2018/abacon/data/detection/1394_SGF/intensity_plot.eps', /ENCAPSULATED
...
SET_PLOT, 'ps'
DEVICE, COLOR = 1, BITS_PER_PIXEL = 8, FILENAME = '/data/khnum/REU2018/abacon/data/detection/1394_SGF/cut_intensity_plot.eps', /ENCAPSULATED

TVLCT, [[0], [0], [0]], 1
PLOT, psym = 3, vel_width[not_cut_ind], coeff_arr_peak[not_cut_ind], XTITLE = 'Line Width [km*s^-1]', YTITLE = 'Peak Instensity [Arb. Units]', TITLE = 'Scatter Plot of Intensity vs Width', /XLOG, /YLOG, XRANGE = [10e-2,10e6], COLOR = 1
TVLCT, [[255], [0], [0]], 255
OPLOT, psym = 3, vel_width[cut_ind], coeff_arr_peak[cut_ind], COLOR = 255
...
;rfname2 = '/data/khnum/REU2018/abacon/data/detection/1394_SGF/all_vars.sav'
