...
coeff_arr_153943_clean = ARRAY_DESPIKE(coeff_arr_153943, sigma = 5, itmax = 10)
...
PLOT_IMAGE, REFORM(coeff_arr_153943[0,*,*]), ORIGIN = [solarx1400_153943[0], solary1400_153943[0]], SCALE = [ResX1400_153943, ResY1400_153943], MIN = 5, MAX = 75, XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0,y0,x0+dx,y0+dy], /NORMAL
...
PLOT_IMAGE, REFORM(vel_width_153943), ORIGIN = [solarx1400_153943[0], solary1400_153943[0]], SCALE = [ResX1400_153943, ResY1400_153943], MIN = 7, MAX = 75, XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0+dx,y0,x0+(2.0*dx),y0+dy], /CURRENT, /NORMAL, /NOERASE, YCHARSIZE = 0.001
...
PLOT_IMAGE, REFORM(velocity_153943), ORIGIN = [solarx1400_153943[0], solary1400_153943[0]], SCALE = [ResX1400_153943, ResY1400_153943], MIN = -35, MAX = 35, XTITLE = 'Solar X [arcsec]', YTITLE = 'Solar Y [arcsec]', POSITION = [x0+(2.0*dx),y0,x0+(3.0*dx),y0+dy], /CURRENT,/NORMAL,/NOERASE, YCHARSIZE = 0.001, TOP = 254
...
SET_PLOT, 'ps'
DEVICE, XSIZE = 15, YSIZE = 9, /INCHES, COLOR = 1, BITS_PER_PIXEL = 8, SET_FONT = 'TIMES', /TT_FONT, FILENAME = '/data/khnum/REU2018/abacon/data/detection/AR11850_20130924_153943/param_maps/param_plot_153943.eps', /ENCAPSULATED
